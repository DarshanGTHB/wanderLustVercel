...
router
    ...
    .get("/listings/new",isLoggedIn,listingController.getNew) //New Route
    .post("/listings",upload.single('listing[image]'),validateListing,wrapAsync(listingController.createListing)) //Create Route
    .get("/listings/:id", wrapAsync(listingController.showLising)) //Show Route
    .get("/listings/:id/edit", isLoggedIn,isOwener ,wrapAsync(listingController.getEditListing)) //Edit Route
